...
\cvevent{Jellyfin for Netcast}{\github{pablouser1/jellyfin-netcast}}{Sept 2019 -- Feb 2022}{}
\en{(\textit{unofficial}) Open source Jellyfin client for Netcast TVs made using JS}
\es{Cliente (\textit{no oficial}) de código abierto para ver Jellyfin en televisiones Netcast hecho con JS}
% -- END PROJECTS -- %
